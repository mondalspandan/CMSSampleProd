...
def nanoAOD_addDeepInfo(process,addDeepBTag,addDeepFlavour,addParticleNet):
    _btagDiscriminators=[]
    if addDeepBTag:
    ...
    if addParticleNet:
        print("Updating process to run ParticleNet in Ak4 jets before it's included in MiniAOD")
...
#            btagDiscriminators = pfParticleNetAK4JetTagsAll
#        )
...
def nanoAOD_customizeCommon(process):
    ...
    nanoAOD_addDeepInfo_switch = cms.PSet(
        ...
        nanoAOD_addParticleNetAK4_switch = cms.untracked.bool(True),
        )
    ...
    process = nanoAOD_addDeepInfo(process,
                                  ...
                                  addParticleNet=nanoAOD_addDeepInfo_switch.nanoAOD_addParticleNetAK4_switch)
