...
jetTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
    ...
    variables = cms.PSet(P4Vars,
        ...
        particleNetAK4_BvAll = Var("?(bDiscriminator('pfParticleNetAK4DiscriminatorsJetTags:BvsAll'))>0?bDiscriminator('pfParticleNetAK4DiscriminatorsJetTags:BvsAll'):-1",float,doc="ParticleNet Ak4 BvsAll",precision=10),
        particleNetAK4_CvL = Var("?(bDiscriminator('pfParticleNetAK4DiscriminatorsJetTags:CvsL'))>0?bDiscriminator('pfParticleNetAK4DiscriminatorsJetTags:CvsL'):-1",float,doc="ParticleNet Ak4 CvsL",precision=10),
        particleNetAK4_CvB = Var("?(bDiscriminator('pfParticleNetAK4DiscriminatorsJetTags:CvsB'))>0?bDiscriminator('pfParticleNetAK4DiscriminatorsJetTags:CvsB'):-1",float,doc="ParticleNet Ak4 CvsB",precision=10),
        particleNetAK4_QvG = Var("?(bDiscriminator('pfParticleNetAK4DiscriminatorsJetTags:QvsG'))>0?bDiscriminator('pfParticleNetAK4DiscriminatorsJetTags:QvsG'):-1",float,doc="ParticleNet Ak4 QvsG",precision=10),
        particleNetAK4_b = Var("?(bDiscriminator('pfParticleNetAK4JetTags:probb'))>0?bDiscriminator('pfParticleNetAK4JetTags:probb'):-1",float,doc="ParticleNet Ak4 QvsG",precision=10),
        particleNetAK4_bb = Var("?(bDiscriminator('pfParticleNetAK4JetTags:probbb'))>0?bDiscriminator('pfParticleNetAK4JetTags:probbb'):-1",float,doc="ParticleNet Ak4 QvsG",precision=10),
        particleNetAK4_c = Var("?(bDiscriminator('pfParticleNetAK4JetTags:probc'))>0?bDiscriminator('pfParticleNetAK4JetTags:probc'):-1",float,doc="ParticleNet Ak4 QvsG",precision=10),
        particleNetAK4_cc = Var("?(bDiscriminator('pfParticleNetAK4JetTags:probcc'))>0?bDiscriminator('pfParticleNetAK4JetTags:probcc'):-1",float,doc="ParticleNet Ak4 QvsG",precision=10),
        particleNetAK4_uds = Var("?(bDiscriminator('pfParticleNetAK4JetTags:probuds'))>0?bDiscriminator('pfParticleNetAK4JetTags:probuds'):-1",float,doc="ParticleNet Ak4 QvsG",precision=10),
        particleNetAK4_g = Var("?(bDiscriminator('pfParticleNetAK4JetTags:probg'))>0?bDiscriminator('pfParticleNetAK4JetTags:probg'):-1",float,doc="ParticleNet Ak4 QvsG",precision=10),
        particleNetAK4_undef = Var("?(bDiscriminator('pfParticleNetAK4JetTags:probundef'))>0?bDiscriminator('pfParticleNetAK4JetTags:probundef'):-1",float,doc="ParticleNet Ak4 QvsG",precision=10),
        particleNetAK4_pu = Var("?(bDiscriminator('pfParticleNetAK4JetTags:probpu'))>0?bDiscriminator('pfParticleNetAK4JetTags:probpu'):-1",float,doc="ParticleNet Ak4 QvsG",precision=10),
